...
<head>
	...
	<title>쏜다넷 - 문자연동, SMS연동, 문자DB연동, SMSDB, DBSMS, DB연동문자, SMS연동, SMSDB연동, 문자메시지, 문자메세지, SMS연동서비스, SMS, LMS, MMS - 쏜다넷 [SMS, SMS연동, 홈페이지SMS연동, 문자연동사이트, SMS문자연동, SMS문자연동서비스,문자, SMS, LMS, 기업형SMS, 기업문자, 기업문자SMS, 기업문자보내기, 문자메세지, 문자전송, 문자발송, 쏜다넷]</title>
	<meta name="title" content="쏜다넷 - 문자연동, SMS연동, 문자DB연동, SMSDB, DBSMS, DB연동문자, SMS연동, SMSDB연동, 문자메시지, 문자메세지, SMS연동서비스, SMS, LMS, MMS - 쏜다넷 [SMS, SMS연동, 홈페이지SMS연동, 문자연동사이트, SMS문자연동, SMS문자연동서비스,문자, SMS, LMS, 기업형SMS, 기업문자, 기업문자SMS, 기업문자보내기, 문자메세지, 문자전송, 문자발송, 쏜다넷]">
	<meta name="keywords" content="쏜다넷,SMS, SMS연동, 홈페이지SMS연동, 문자연동사이트, SMS문자연동, SMS문자연동서비스,문자, SMS, LMS, 기업형SMS, 기업문자, 기업문자SMS, 기업문자보내기, 문자메세지, 문자전송, 문자발송, 쏜다넷">
	<meta name="description" content="쏜다넷 - 문자연동, SMS연동, 문자DB연동, SMSDB, DBSMS, DB연동문자, SMS연동, SMSDB연동, 문자메시지, 문자메세지, SMS연동서비스, SMS, LMS, MMS - 쏜다넷 [문자연동, SMS연동, SMS,문자메세지, 문자메시지, 단문자사이트, SMS보내기, LMS문자, 그림문자, 포토문자, SMS서비스, 장문문자, 엑셀문자, 쏜다넷]">
	<meta name="Subject" content="쏜다넷 - 문자연동, SMS연동, 문자DB연동, SMSDB, DBSMS, DB연동문자, SMS연동, SMSDB연동, 문자메시지, 문자메세지, SMS연동서비스, SMS, LMS, MMS - 쏜다넷 [SMS, SMS연동, 홈페이지SMS연동, 문자연동사이트, SMS문자연동, SMS문자연동서비스,문자, SMS, LMS, 기업형SMS, 기업문자, 기업문자SMS, 기업문자보내기, 문자메세지, 문자전송, 문자발송, 쏜다넷]">
	...
	<meta property='og:title' content='쏜다넷 - 문자연동, SMS연동, 문자DB연동, SMSDB, DBSMS, DB연동문자, SMS연동, SMSDB연동, 문자메시지, 문자메세지, SMS연동서비스, SMS, LMS, MMS - 쏜다넷 [SMS, SMS연동, 홈페이지SMS연동, 문자연동사이트, SMS문자연동, SMS문자연동서비스,문자, SMS, LMS, 기업형SMS, 기업문자, 기업문자SMS, 기업문자보내기, 문자메세지, 문자전송, 문자발송, 쏜다넷]'>
	<meta property='og:description' content='쏜다넷 - 문자연동, SMS연동, 문자DB연동, SMSDB, DBSMS, DB연동문자, SMS연동, SMSDB연동, 문자메시지, 문자메세지, SMS연동서비스, SMS, LMS, MMS - 쏜다넷 [문자연동, SMS연동, SMS,문자메세지, 문자메시지, 단문자사이트, SMS보내기, LMS문자, 그림문자, 포토문자, SMS서비스, 장문문자, 엑셀문자, 쏜다넷]'>
...
<div id="page-info">
	<!-- page title -->
	<h1 class="page-title">문자연동, SMS연동, 문자DB연동, SMSDB, DBSMS, DB연동문자, SMS연동, SMSDB연동, 문자메시지, 문자메세지, SMS연동서비스, SMS, LMS, MMS - 쏜다넷</h1>

	<!-- page keywords -->
	<h2 class="page-keywords">SMS, SMS연동, 홈페이지SMS연동, 문자연동사이트, SMS문자연동, SMS문자연동서비스,문자, SMS, LMS, 기업형SMS, 기업문자, 기업문자SMS, 기업문자보내기, 문자메세지, 문자전송, 문자발송, 쏜다넷</h1>

	<!-- page description -->
	<h3 class="page-description">문자연동, SMS연동, SMS,문자메세지, 문자메시지, 단문자사이트, SMS보내기, LMS문자, 그림문자, 포토문자, SMS서비스, 장문문자, 엑셀문자, 쏜다넷</h1>
</div>
<!-- navigation start -->
		...
		<div class="row">
			...
			<div class="collapse navbar-collapse bs-navbar-collapse" role="navigation" id="bs-navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" data-id="menu-asp" data-flag="move" href="xdb.asp" id="topmenu_05">문자연동</a>
						<ul class="dropdown-menu" role="menu">
							<li><a href="xdb.asp">DB 문자연동</a></li>
							<li><a href="socket.asp">소켓 문자연동</a></li>
							<li><a href="dll.asp">DLL 문자연동</a></li>
...
<div id="bodyWrapper"><div class="container">
	<div class="site-position">
		<a href="../../index.asp">Home</a><i class="fa fa-angle-right"></i><a href="xdb.asp">문자연동</a><i class="fa fa-angle-right"></i>
		<span class="dropdown">
			<a class="dropdown-toggle now" data-toggle="dropdown" href="#" id="curr_menu"></a>
			<ul class="dropdown-menu pull-right" role="menu">
				<li id="pos_01"><a href="xdb.asp">DB 문자연동</a>
				<li id="pos_03"><a href="socket.asp">소켓 문자연동</a>
				<li id="pos_04"><a href="dll.asp">DLL 문자연동</a>
				<li id="pos_02"><a href="../pay/msg/list.asp%3Fspkind=B&menu=02">연동 요금안내</a>
			</ul>
		</span>
	</div>
</div>
	...
	<div class="row">
		...
		<div class="panel panel-sm panel-success">
			<div class="panel-heading">
				<h4><i class="fa fa-share-alt marginR5"></i>문자연동</h4>
			</div>
			<div class="list-group">
				<a href="xdb.asp" class="list-group-item" id="left_01">DB 문자연동</a>
				<a href="socket.asp" class="list-group-item" id="left_03">소켓 문자연동</a>
				<a href="dll.asp" class="list-group-item" id="left_04">DLL 문자연동</a>
				<a href="../pay/msg/list.asp%3Fspkind=B&menu=02" class="list-group-item" id="left_02">연동 요금안내</a>
			</div>
		</div>
	...
	<div class="">
		...
		<div class="col-md-9 col-sm-12 col-xs-12">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="page-nav">
					<ul class="nav nav-pills">
						<li id="tab_01" class=""><a href="xdb.asp">DB 문자연동</a></li>
						<li id="tab_02" class=""><a href="socket.asp">소켓 문자연동</a></li>
						<li id="tab_03" class=""><a href="dll.asp">DLL 문자연동</a></li>
					</ul>
				</div>
			</div>
		</div>
			<div class="row marginT20">
				...
				<h4 class="text-info">DB 문자연동<small class="marginL30 f12px hidden-xs"><span class="text-primary fBold">자체DB보유</span> 고객님을 위한 문자연동 서비스입니다.</small></h4>
				<hr>
				<small>
						<p>기업의 대형 어플리케이션에서 쉽게 적용할 수 있는 <b>데이터베이스와의 연동</b>을 통해 문자연동이 가능합니다.</p>
						<p class="hidden-xs marginT20">즉, 기업의 어플리케이션이 사용하는 데이터베이스에 메시지용 테이블이 자동생성되고,</p>
						<p class="hidden-xs">메시지 전송이 필요한 경우 해당 테이블에 정보를 입력합니다.</p>
						<p class="hidden-xs">이후 쏜다넷 XDB 모듈이 해당 정보를 이용하여 메시지를 자동으로 전송하고 결과를 수신합니다.</p>
						<p class="hidden-xs marginT20"><b>XDB 2.0</b> 부터는 SMS연동, LMS연동, MMS연동이 가능합니다.</p>
				</small>
			</div>
			<div class="text-center">
				<a href="../pay/msg/list.asp%3Fspkind=B&menu=02" class="btn btn-sm btn-dark"><i class="fa fa-info-circle marginR5"></i>연동 요금안내 / 견적신청하기</a>
			</div>
			<div class="panel panel-danger marginT20">
				<div class="panel-heading">
					<h5 class="panel-title"><i class="fa fa-check fa-lg marginR10"></i>OS 및 DB별 서비스 환경 지원</h5>
				</div>
				<div class="panel-body">
						<p>OS 및 DB 별 서비스 환경 지원(모듈 무상 제공)으로 대량자동전송 및 전송결과 수신을 제공합니다.</p>
				</div>
			</div>

			<div class="panel panel-success">
				<div class="panel-heading">
					<h5 class="panel-title"><i class="fa fa-check fa-lg marginR10"></i>XDB 2.0 메시징 서비스 종류별 특징</h5>
				</div>
				<div class="panel-body">
					<div class="table-responsive">
						<table class="table table-striped table-bordered table-condensed marginB0">
							<thead>
								<tr>
									<th class="text-center bg-gray f12px">구 분</th>
									<th class="text-center bg-gray f12px">문자길이</th>
									<th class="text-center bg-gray f12px">전송컨텐츠</th>
									<th class="text-center bg-gray f12px">전송망</th>
									<th class="text-center bg-gray f12px">수신확인</th>
									<th class="text-center bg-gray f12px">적용단말기</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td class="f12px text-primary">SMS (단문)</td>
									<td class="f12px">90byte</td>
									<td class="f12px">Text</td>
									<td class="f12px">음성망</td>
									<td class="f12px">즉시확인</td>
									<td class="f12px">모든 휴대폰 가능</td>
								</tr>
								<tr>
									<td class="f12px text-primary">LMS (장문)</td>
									<td class="f12px">2,000byte</td>
									<td class="f12px">Text</td>
									<td class="f12px">데이터망</td>
									<td class="f12px">즉시확인</td>
									<td class="f12px">MMS 지원 단말기</td>
								</tr>
								<tr>
									<td class="f12px text-primary">MMS (멀티)</td>
									<td class="f12px">2,000byte</td>
									<td class="f12px">Text, Image, Audio, Video </td>
									<td class="f12px">데이터망</td>
									<td class="f12px">즉시확인</td>
									<td class="f12px">MMS 지원 단말기</td>
								</tr>
			...
			<div class="panel panel-danger">
				<div class="panel-heading">
					<h5 class="panel-title"><i class="fa fa-check fa-lg marginR10"></i>연동 가능 환경</h5>
				</div>
				<div class="panel-body">
						<p>로그인 후 <span class='label label-primary'>마이페이지</span> <i class="fa fa-arrow-right"></i> <span class='label label-primary'>계정관리</span> 에서 <span class='label label-primary'>계정추가</span> 후 연동 파일을 다운로드 하실 수 있습니다. <a href="javascript:menuURL('https://www.xonda.net/xclient/member/slave_list.asp');" class='label label-primary marginL10'><i class="fa fa-caret-right marginR5"></i>계정추가 <span class="fYellow">바로가기</span></a></p>
				</div>

				<div class="panel-body">
					<div class="btn-group" role="group">
						<button type="button" class="btn btn-md btn-warning" onclick="downModule('', 0, 22, 'XDB2.0_linux_java', 'DB')"><i class="fa fa-download marginR5"></i>XDB2.0 Linux</button>
						<button type="button" class="btn btn-md btn-success" onclick="downModule('', 0, 23, 'XDB2.0_windows_JDBC', 'DB')"><i class="fa fa-download marginR5"></i>XDB2.0 Windows</button>
					</div>
					<div class="marginT20">
						<a class="btn btn-xs btn-dark" href="https://blog.naver.com/xondanet1/221876047481" target="_new"><img src="../images/media/NAVERBLOG.png" class="marginR10">대량문자 DB 문자연동 방법</a>
					</div>
				</div>
				<div class="panel-body marginT10">
					<small>
						<ol class="paddingL20">
							<li><p>지원 DB - <span class="text-primary">MYSQL, MSSQL, ORACLE, DB2, SYBASE, CUBRID, MARIADB</span> 등</p></li>
							<li><p>지원 OS - <span class="text-primary">WINDOWS/NT, LINUX/UNIX</span></p></li>
							<li><p>메시지 전송은 <span class="text-primary">SOCKET 통신</span>을 합니다.</p></li>
							<li><p>고객사에서는 네트워크 담당자에게 방화벽 설정을 요청하십시오.</p></li>
							<li><p><span class="text-danger">전송 인터페이스는 고객사에서 직접 개발 하여야 합니다.</span></p></li>
							<li><p>패스워드 변경시 연동설정을 함께 변경하셔야하므로 <span class="text-danger">서브계정을 사용</span>하시길 권장합니다.</p></li>
						</ol>
					</small>
				</div>
			</div>
...
<div class="modal fade" id="layerModule" tabindex="-1" role="dialog" aria-labelledby="layerDownLabel" data-backdrop="static">
	<div class="modal-dialog animated bounceInRight type-success">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span>&times;</span><span class="sr-only">Close</span></button>
				<h4 class="modal-title" id="layerDownLabel" align="center">연동모듈 다운로드</h4>
			</div>
			<div class="modal-body">
				<div class="infobox_body">
					<small>
						<p><i class="fa fa-angle-right"></i>&nbsp;<span id="spanModuleName" class="text-danger">xdb2.0_linux_java</span> 모듈을 다운로드합니다.</p>
						<p><i class="fa fa-angle-right"></i>&nbsp;DB를 사용하지 않으면 DBMS 종류는 입력하지 않으셔도 됩니다.</p>
					</small>
				</div>
				<form role="form" name="frmModule" method="post" target="frameHidden" action="https://www.xonda.net/xclient/enterpriseASP/downModule.asp">
				<input type="hidden" name="seq" id="moduleseq" value="">
				<input type="hidden" name="post" id="modulepost" value="">
				<div class="form-group">
					<div class="input-group input-group-sm marginT5 has-error">
						<span class="input-group-addon"><i class="fa fa-edit marginR5"></i>OS(서버) 종류</span>
						<input type="text" class="form-control" name="servern" id="servern" placeholder="예) Windows Server 2012 R2" value="" required>
					</div>
					<div class="input-group input-group-sm marginT5" id="divDBMS">
						<span class="input-group-addon"><i class="fa fa-edit marginR5"></i>DBMS 종류&nbsp;&nbsp;&nbsp;&nbsp;</span>
						<input type="text" class="form-control" name="dbn" id="dbn" placeholder="예) MS-SQL Server 2008" value="">
					</div>
				</div>
				</form>
				<div class="text-center">
					<a class="btn btn-success" onclick="downModuleProc()">다운로드</a>
					&nbsp;
...
<script type="text/javascript">
function downModule(id,cnt,seq,name,post){
	if(id == ""){
		loginLayer("");
	}else if(cnt == 0){
		makeAlert("<b>마이페이지 &gt; 계정관리</b> 메뉴에서 하위계정 추가 후 다운로드 가능합니다.");
	}else if(seq == 0){
		makeAlert("다운로드 가능한 모듈이 없습니다.");
	}else{
		if(post == "DB")
			$("#divDBMS").addClass("has-error");
		else
			$("#divDBMS").removeClass("has-error");

		document.frmModule.seq.value = seq;
		document.frmModule.post.value = post;
		$("#spanModuleName").html(name);
		$("#layerModule").modal("show");
	}
}
function downModuleProc() {
	var frm = document.frmModule;
	if ($("#servern").pval() == "") {
		makeAlert('OS(서버)종류를 입력해주세요.');
		return;
	}else if(frm.post.value == "DB" && $("#dbn").pval() == ""){
		makeAlert('DBMS 종류를 입력해주세요.');
		return;
	} else {
		if($("#dbn").pval() == "") $("#dbn").val(" ");	//IE8때문 (뒷단에서 trim())
		frm.submit();
		$("#layerModule").modal("hide");
	}
}
</script>	<div class="marginT20">&nbsp;</div>
</div>
<div id="bodyMargin" style="background:#FCFCFC;"></div>
<div id="footWrapper">

		<div class=""><!-- BANNER / 연동서비스 -->
<div class="main-banner-bar type2">
	<div class="container">
		<div class="title">쉽고 빠른 <b>문자연동</b> 서비스!!</div>
		<div class="desc">저렴한 연동요금제로 부담없이 보내세요.</div>
		<div class="box">
			<div class="btn-group btn-group-justified" role="group">
				<a class="btn btn-success" href="https://blog.naver.com/xondanet1/221876047481" target="_new"><img src="../images/media/NAVERBLOG.png"> 연동방법</a>
				<a class="btn btn-dark marginL10" href="../pay/msg/list.asp%3Fspkind=B&menu=02">요금제보기</a>
				<a class="btn btn-primary marginL10" href="../service/proposal.asp">견적신청</a>
			</div>
		</div>
	</div>
</div></div>
		...
		<div class="modal-dialog type-primary">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="nexturl" value="/xclient/enterpriseASP/xdb.asp">
