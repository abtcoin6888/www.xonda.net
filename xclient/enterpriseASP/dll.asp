...
<head>
	...
	<title>쏜다넷 - 문자연동, SMS연동, SMSDLL연동, DLL문자연동, SMSDLL, SMS연동, LMS연동, MMS연동,  SMS웹연동, 단체문자, 대량문자, 문자메시지, 문자메세지, 문자, SMS, LMS, MMS, SMS연동서비스 - 쏜다넷 [SMS, SMS연동, 홈페이지SMS연동, 문자연동사이트, SMS문자연동, SMS문자연동서비스,문자, SMS, LMS, 기업형SMS, 기업문자, 기업문자SMS, 기업문자보내기, 문자메세지, 문자전송, 문자발송, 쏜다넷]</title>
	<meta name="title" content="쏜다넷 - 문자연동, SMS연동, SMSDLL연동, DLL문자연동, SMSDLL, SMS연동, LMS연동, MMS연동,  SMS웹연동, 단체문자, 대량문자, 문자메시지, 문자메세지, 문자, SMS, LMS, MMS, SMS연동서비스 - 쏜다넷 [SMS, SMS연동, 홈페이지SMS연동, 문자연동사이트, SMS문자연동, SMS문자연동서비스,문자, SMS, LMS, 기업형SMS, 기업문자, 기업문자SMS, 기업문자보내기, 문자메세지, 문자전송, 문자발송, 쏜다넷]">
	...
	<meta name="description" content="쏜다넷 - 문자연동, SMS연동, SMSDLL연동, DLL문자연동, SMSDLL, SMS연동, LMS연동, MMS연동,  SMS웹연동, 단체문자, 대량문자, 문자메시지, 문자메세지, 문자, SMS, LMS, MMS, SMS연동서비스 - 쏜다넷 [문자연동, SMS연동, SMS, 문자메세지, 문자메시지, 단문자사이트, SMS보내기,컴퓨터문자메세지보내기, LMS문자, 그림문자, 포토문자, SMS서비스, 장문문자, 엑셀문자, 쏜다넷]">
	<meta name="Subject" content="쏜다넷 - 문자연동, SMS연동, SMSDLL연동, DLL문자연동, SMSDLL, SMS연동, LMS연동, MMS연동,  SMS웹연동, 단체문자, 대량문자, 문자메시지, 문자메세지, 문자, SMS, LMS, MMS, SMS연동서비스 - 쏜다넷 [SMS, SMS연동, 홈페이지SMS연동, 문자연동사이트, SMS문자연동, SMS문자연동서비스,문자, SMS, LMS, 기업형SMS, 기업문자, 기업문자SMS, 기업문자보내기, 문자메세지, 문자전송, 문자발송, 쏜다넷]">
	...
	<meta property='og:title' content='쏜다넷 - 문자연동, SMS연동, SMSDLL연동, DLL문자연동, SMSDLL, SMS연동, LMS연동, MMS연동,  SMS웹연동, 단체문자, 대량문자, 문자메시지, 문자메세지, 문자, SMS, LMS, MMS, SMS연동서비스 - 쏜다넷 [SMS, SMS연동, 홈페이지SMS연동, 문자연동사이트, SMS문자연동, SMS문자연동서비스,문자, SMS, LMS, 기업형SMS, 기업문자, 기업문자SMS, 기업문자보내기, 문자메세지, 문자전송, 문자발송, 쏜다넷]'>
	<meta property='og:description' content='쏜다넷 - 문자연동, SMS연동, SMSDLL연동, DLL문자연동, SMSDLL, SMS연동, LMS연동, MMS연동,  SMS웹연동, 단체문자, 대량문자, 문자메시지, 문자메세지, 문자, SMS, LMS, MMS, SMS연동서비스 - 쏜다넷 [문자연동, SMS연동, SMS, 문자메세지, 문자메시지, 단문자사이트, SMS보내기,컴퓨터문자메세지보내기, LMS문자, 그림문자, 포토문자, SMS서비스, 장문문자, 엑셀문자, 쏜다넷]'>
...
<div id="page-info">
	<!-- page title -->
	<h1 class="page-title">문자연동, SMS연동, SMSDLL연동, DLL문자연동, SMSDLL, SMS연동, LMS연동, MMS연동,  SMS웹연동, 단체문자, 대량문자, 문자메시지, 문자메세지, 문자, SMS, LMS, MMS, SMS연동서비스 - 쏜다넷</h1>
	...
	<!-- page description -->
	<h3 class="page-description">문자연동, SMS연동, SMS, 문자메세지, 문자메시지, 단문자사이트, SMS보내기,컴퓨터문자메세지보내기, LMS문자, 그림문자, 포토문자, SMS서비스, 장문문자, 엑셀문자, 쏜다넷</h1>
</div>
<!-- navigation start -->
	...
	<div class="">
		...
		<div class="col-md-9 col-sm-12 col-xs-12">
			...
			<div class="row marginT20">
				...
				<h4 class="text-info">DLL 문자연동<small class="marginL30 f12px hidden-xs"><span class="text-primary fBold">SOAP/DLL</span> 로 제공되는 SMS연동 서비스입니다.</small></h4>
				<hr>
				<small>
						<p>쏜다넷 제공 <b>DLL</b> 을 이용, <b>SOAP</b> 기반의 통신을 하여 SMS 전송을 할 수 있습니다. (with DLL)</p>
						<p>고객사에서 직접 SOAP 를 이용하여 SMS 전송을 할 수도 있습니다. (without DLL)</p>
				</small>
			</div>
			...
			<div class="panel panel-danger marginT20">
				<div class="panel-heading">
					<h5 class="panel-title"><i class="fa fa-check fa-lg marginR10"></i>다양한 언어에서도 제한없이 사용</h5>
				</div>
				<div class="panel-body">
						<p>다양한 언어에서 사용이 가능하며, 기업 SMS 시스템을 보유한 것과 같은 성능과 효과를 제공받을 수 있습니다.</p>
				</div>
			</div>

			<div class="panel panel-info">
				<div class="panel-heading">
					<h5 class="panel-title"><i class="fa fa-check fa-lg marginR10"></i>서비스 구성도</h5>
				</div>
				<div class="panel-body">
						<p class="text-center"><img src="images/appli_conimg01.gif" style="max-width: 100%; height: auto;"></p>
				</div>
			</div>
			...
			<div class="panel panel-danger">
				...
				<div class="panel-body">
					<div class="btn-group" role="group">
						<button type="button" class="btn btn-md btn-warning" onclick="downModule('', 0, 0, '', 'DLL')"><i class="fa fa-download marginR5"></i>MFC용</button>
						<button type="button" class="btn btn-md btn-info" onclick="downModule('', 0, 0, '', 'DLL')"><i class="fa fa-download marginR5"></i>VB용</button>
						<button type="button" class="btn btn-md btn-success" onclick="downModule('', 0, 0, '', 'DLL')"><i class="fa fa-download marginR5"></i>WIN32용</button>
					</div>
				</div>
				<div class="panel-body marginT10">
					<small>
						<ol class="paddingL20">
							<li><p>고객사에서 제작한 UI에 맞는 컴포넌트를 제공합니다.</p>
							<li><p>메시지 전송은 <span class="text-primary">SOCKET 통신</span>을 하며, <span class="text-danger">SMS(단문)전송만 가능</span>합니다.</p></li>
							<li><p>해당 연동소스는 차후, 통합메시지전송(SMS, LMS, MMS)을 위한 소스와 호환이 되지 않을 수 있습니다.</p></li>
		...
		<div class="modal-dialog type-primary">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="nexturl" value="/xclient/enterpriseASP/dll.asp">
