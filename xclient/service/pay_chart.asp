	...
	<div class="container hidden-xs">
		<div class="row">
			<div class="navbar-quick">
				...
				<a href="sitemap.asp"><i class="fa fa-th marginR5"></i>사이트맵</a>
			</div>
		</div>
	</div>
	<div class="container">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<a class="btn btn-xs btn-warning marginL5" href="pay_chart.asp"><i class="fa fa-info-circle marginR5"></i>요금안내</a>
				</div>
			</div>
		</div>
	</div>
...
<div id="bodyWrapper"><div class="container">
	<div class="site-position">
		<a href="../../index.asp">Home</a><i class="fa fa-angle-right"></i><a href="../payment/pay_main.asp">충전하기</a><i class="fa fa-angle-right"></i>
		<span class="dropdown">
			...
			<ul class="dropdown-menu pull-right" role="menu">
				...
				<li id="pos_05"><a href="proposal.asp">견적신청</a></li>
	...
	<div class="row">
		...
		<div class="panel panel-sm panel-success">
			...
			<div class="list-group">
				...
				<a href="proposal.asp" class="list-group-item" id="left_05">견적서신청</a>
		...
		<div class="modal-dialog type-primary">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="nexturl" value="/xclient/service/pay_chart.asp">
