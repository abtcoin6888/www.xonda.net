...
<head>
	...
	<title>쏜다넷 - 사이트맵 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]</title>
	<meta name="title" content="쏜다넷 - 사이트맵 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]">
	...
	<meta name="description" content="쏜다넷 - 사이트맵 [단체문자보내기,단체문자발송,문자사이트,SMS보내기,컴퓨터문자메세지보내기,웹발신문자,LMS문자,KT문자,SKT문자,LGT문자,그림문자,포토문자,WEB발신,SMS서비스,장문문자,엑셀문자,PC문자]">
	<meta name="Subject" content="쏜다넷 - 사이트맵 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]">
	...
	<meta property='og:title' content='쏜다넷 - 사이트맵 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]'>
	<meta property='og:description' content='쏜다넷 - 사이트맵 [단체문자보내기,단체문자발송,문자사이트,SMS보내기,컴퓨터문자메세지보내기,웹발신문자,LMS문자,KT문자,SKT문자,LGT문자,그림문자,포토문자,WEB발신,SMS서비스,장문문자,엑셀문자,PC문자]'>
...
<div id="bodyWrapper"><div class="container">
	<div class="site-position">
		<a href="../../index.asp">Home</a><i class="fa fa-angle-right"></i><a href="service_info.asp">서비스 안내</a><i class="fa fa-angle-right"></i>
		<span class="dropdown">
			<a class="dropdown-toggle now" data-toggle="dropdown" href="#" id="curr_menu"></a>
			<ul class="dropdown-menu pull-right" role="menu">
				<li id="pos_01"><a href="service_info.asp">서비스안내</a></li>
				<li id="pos_03"><a href="pay_chart.asp">요금안내</a></li>
				<li id="pos_05"><a href="proposal.asp">견적서신청</a></li>
				<li id="pos_02"><a href="sitemap.asp">사이트맵</a></li>
				<li id="pos_04"><a href="http://ir.xonda.net" target="_new">회사소개</a></li>
			</ul>
		</span>
	</div>
</div>
	...
	<div class="row">
		...
		<div class="panel panel-sm panel-success">
			<div class="panel-heading">
				<h4><i class="fa fa-info-circle marginR5"></i>서비스 안내</h4>
			</div>
			<div class="list-group">
				<a href="service_info.asp" class="list-group-item" id="left_01">서비스안내</a>
				<a href="../pay/msg/list.asp%3Fspkind=B&menu=03" class="list-group-item" id="left_03">요금안내</a>
				<a href="proposal.asp" class="list-group-item" id="left_05">견적서신청</a>
				<a href="sitemap.asp" class="list-group-item" id="left_02">사이트맵</a>
				<a href="https://ir.xonda.net" target="_new" class="list-group-item" id="left_04">회사소개</a>
			</div>
			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
					<div class="panel panel-default">
						<div class="panel-heading panel-heading-sm"><i class="fa fa-send marginR5"></i>일반문자</div>
						<ul class="sitemap" role="menu">
							<li><i class="fa fa-caret-right marginR5"></i><a href="../message/sms.asp">단문전송</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../message/lms.asp">장문전송</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../message/mms.asp">포토전송</a></li>
							<li class="divider"></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../message/emoticon_sms.asp">단문이모티콘</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../message/emoticon_lms.asp">장문이모티콘</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
					<div class="panel panel-default">
						<div class="panel-heading panel-heading-sm"><i class="fa fa-send marginR5"></i>광고문자</div>
						<ul class="sitemap" role="menu">
							<li><i class="fa fa-caret-right marginR5"></i><a href="../message/sms_ad.asp">단문전송</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../message/lms_ad.asp">장문전송</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../message/mms_ad.asp">포토전송</a></li>
							<li class="divider"></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../message/ad_duty.asp">광고문자 이용안내</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
					<div class="panel panel-default">
						<div class="panel-heading panel-heading-sm"><i class="fa fa-group marginR5"></i>주소록</div>
						<ul class="sitemap" role="menu">
							<li><i class="fa fa-caret-right marginR5"></i><a href="../address/address.asp">주소록관리</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../address/address_import.asp">주소록가져오기</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../address/address_export.asp">주소록내보내기</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
					<div class="panel panel-default">
						<div class="panel-heading panel-heading-sm"><i class="fa fa-bar-chart-o marginR5"></i>전송관리</div>
						<ul class="sitemap" role="menu">
							<li><i class="fa fa-caret-right marginR5"></i><a href="../statistics/sent_msg.asp">전송결과</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../statistics/reserve_list.asp">예약관리</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../statistics/stat_list.asp">전송통계</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
					<div class="panel panel-default">
						<div class="panel-heading panel-heading-sm"><i class="fa fa-phone-square marginR5"></i>발신번호</div>
						<ul class="sitemap" role="menu">
							<li><i class="fa fa-caret-right marginR5"></i><a href="../message/callback.asp">발신번호 등록안내</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="javascript:goCallbackMng()">발신번호 관리</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
					<div class="panel panel-default">
						<div class="panel-heading panel-heading-sm"><i class="fa fa-share-alt marginR5"></i>문자연동</div>
						<ul class="sitemap" role="menu">
							<li><i class="fa fa-caret-right marginR5"></i><a href="../enterpriseASP/xdb.asp">DB 문자연동</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../enterpriseASP/socket.asp">소켓 문자연동</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../enterpriseASP/dll.asp">DLL 문자연동</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
					<div class="panel panel-default">
						<div class="panel-heading panel-heading-sm"><i class="fa fa-star marginR5"></i>MO서비스</div>
						<ul class="sitemap" role="menu">
							<li><i class="fa fa-caret-right marginR5"></i><a href="../event/index.asp">서비스신청</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../event/payment.asp">요금안내</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../event/event.asp">MO이벤트</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../event/gift.asp">기프트몰</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
					<div class="panel panel-default">
						<div class="panel-heading panel-heading-sm"><i class="fa fa-volume-down marginR5"></i>고객센터</div>
						<ul class="sitemap" role="menu">
							<li><i class="fa fa-caret-right marginR5"></i><a href="../customer/notice_list.asp">공지사항</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../customer/faq_list.asp">FAQ</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../customer/tip_list.asp">전송TIP</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../customer/sns_list.asp%3FB_CD=SNS1">도움말</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../customer/sns_list.asp%3FB_CD=SNS2">상황별 문자내용</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../customer/event.asp">이벤트</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="panel panel-warning">
						<div class="panel-heading panel-heading-sm"><i class="fa fa-user marginR5"></i>마이메뉴</div>
						<ul class="sitemap" role="menu">
							<li><i class="fa fa-caret-right marginR5"></i><a href="../member/myinfo.asp">정보수정</a></li>
	
							<li><i class="fa fa-caret-right marginR5"></i><a href="../member/use_list.asp">사용내역</a></li>
	
							<li><i class="fa fa-caret-right marginR5"></i><a href="../member/qna_list.asp">1:1문의</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../member/mymenu.asp%3Fopen=etax">전자세금계산서신청</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="panel panel-danger">
						<div class="panel-heading panel-heading-sm"><i class="fa fa-info-circle marginR5"></i>서비스 안내</div>
						<ul class="sitemap" role="menu">
							<li><i class="fa fa-caret-right marginR5"></i><a href="service_info.asp">서비스 안내</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="pay_chart.asp">요금안내</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="proposal.asp">제안서/견적서신청</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="http://ir.xonda.net" target="_new">회사소개</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="sitemap.asp">사이트맵</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="panel panel-success">
						<div class="panel-heading panel-heading-sm"><i class="fa fa-user marginR5"></i>회원서비스</div>
						<ul class="sitemap" role="menu">
							<li><i class="fa fa-caret-right marginR5"></i><a href="../member/joinstep1.asp">회원가입</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../member/findidpw.asp">아이디/패스워드찾기</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="../member/login.asp">로그인</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="javascript:viewAgreement()">서비스이용약관</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="javascript:viewPrivacy()">개인정보취급방침</a></li>
							<li><i class="fa fa-caret-right marginR5"></i><a href="javascript:viewNospam()">스팸관리규약</a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="modal-dialog type-primary">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="nexturl" value="/xclient/service/sitemap.asp">
