...
<head>
	...
	<title>쏜다넷 - 서비스안내 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]</title>
	<meta name="title" content="쏜다넷 - 서비스안내 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]">
	...
	<meta name="description" content="쏜다넷 - 서비스안내 [단체문자보내기,단체문자발송,문자사이트,SMS보내기,컴퓨터문자메세지보내기,웹발신문자,LMS문자,KT문자,SKT문자,LGT문자,그림문자,포토문자,WEB발신,SMS서비스,장문문자,엑셀문자,PC문자]">
	<meta name="Subject" content="쏜다넷 - 서비스안내 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]">
	...
	<meta property='og:title' content='쏜다넷 - 서비스안내 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]'>
	<meta property='og:description' content='쏜다넷 - 서비스안내 [단체문자보내기,단체문자발송,문자사이트,SMS보내기,컴퓨터문자메세지보내기,웹발신문자,LMS문자,KT문자,SKT문자,LGT문자,그림문자,포토문자,WEB발신,SMS서비스,장문문자,엑셀문자,PC문자]'>
		...
		for(var i=1; i<=3; i++){
			...
			if(i == no){
				if(!$(obj1).hasClass("active")){
					...
					$(obj2).removeClass("display-none");
				}
			}else{
				if($(obj1).hasClass("active")){
					$(obj1).removeClass("active");
					$(obj2).addClass("display-none");
				}
			}
		}
	}
	...
	<div class="">
		...
		<div class="col-md-9 col-sm-12 col-xs-12">
			<div class="bs-callout bs-callout-danger">
				<h4 class="text-info">서비스 안내</h4>
				<p><small>쏜다넷은 회원가입 후 이용가능합니다.</small></p>
			</div>
			<div class="row service-tab">
				<div class="col-xs-4">
					<div class="tab-box">
						<div class="tab" id="divTab1" data-code="1"><i class="fa fa-arrow-circle-right marginR5"></i>회원가입</div>
					</div>
				</div>
				<div class="col-xs-4">
					<div class="tab-box">
						<div class="tab" id="divTab2" data-code="2"><i class="fa fa-arrow-circle-right marginR5"></i>서비스찾기</div>
					</div>
				</div>
				<div class="col-xs-4">
					<div class="tab-box">
						<div class="tab" id="divTab3" data-code="3"><i class="fa fa-arrow-circle-right marginR5"></i>결제하기</div>
					</div>
				</div>
			</div>
			<div class="marginT20">
					<div id="divSvc1" class="service-contents display-none">
						<h5>1. 좌측 상단 - 회원가입</h5>
						<div><img src="../images/service/svc_01_01.gif"></div>

						<h5>2. 약관 동의 후 개인 또는 개인 회원가입</h5>
						<div><img src="../images/service/svc_01_02.gif"></div>
					</div>
					<div id="divSvc2" class="service-contents display-none">
						<h5>1. 사이트 이용</h5>
						<div><p>연동을 원하지 않으실 경우 쏜다넷 사이트에서 이용가능합니다.</p><p>주소록, 단문전송, 장문전송, 포토전송, 엑셀전송 모두 제공됩니다.</p></div>
						<h5>2. 연동형 서비스 이용</h5>
						<div>
							<img src="../images/service/svc_02.gif">
							<p class="center marginT20"><a href="../enterpriseASP/xdb.asp" class="btn btn-success">자세히보기</a></p>
						</div>
					</div>
					<div id="divSvc3" class="service-contents display-none">
						<h5>1. 충전결제 후 이용가능</h5>
						<div>
							<img src="../images/service/svc_04.gif">
							<p class="center marginT20"><a href="../payment/pay_main.asp" class="btn btn-success">충전결제하기</a></p>
						</div>
					</div>
			</div>
		</div>
		...
		<div class="modal-dialog type-primary">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="nexturl" value="/xclient/service/service_info.asp">
