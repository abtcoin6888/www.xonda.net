	...
	<title>쏜다넷 - 광고문자 이용안내</title>
	<meta name="title" content="쏜다넷 - 광고문자 이용안내">
	...
	<meta name="description" content="쏜다넷 - 단체문자보내기,단체문자발송,문자사이트,SMS보내기,컴퓨터문자메세지보내기,웹발신문자,LMS문자,KT문자,SKT문자,LGT문자,그림문자,포토문자,WEB발신,SMS서비스,장문문자,엑셀문자,PC문자">
	<meta name="Subject" content="쏜다넷 - 광고문자 이용안내">
	...
	<meta property='og:title' content='쏜다넷 - 광고문자 이용안내'>
	<meta property='og:description' content='쏜다넷 - 단체문자보내기,단체문자발송,문자사이트,SMS보내기,컴퓨터문자메세지보내기,웹발신문자,LMS문자,KT문자,SKT문자,LGT문자,그림문자,포토문자,WEB발신,SMS서비스,장문문자,엑셀문자,PC문자'>
...
<div id="page-info">
	<!-- page title -->
	<h1 class="page-title">광고문자 이용안내</h1>
	...
	<div class="container">
		...
		<div class="panel panel-sm panel-msg">
			...
			<div class="list-group">
				...
				<a href="ad_duty.asp" class="list-group-item fLRed" id="left_07">광고문자 이용안내</a>
			</div>
		</div>
		...
		<div class="carousel xonda-carousel slide" data-ride="carousel" data-interval="3500" id="left-carousel">
			...
			<div class="col-md-9 col-sm-12 col-xs-12">
				<div class="bs-callout bs-callout-danger">
					<h4 class="text-info">광고문자 이용안내</h4>
					<p><small>광고문자 발송시 표기 의무사항을 반드시 지켜주셔야합니다.</small></p>
				</div>


				<div class="panel panel-secondary-gradient marginT10 marginB0">
					...
					<div class="panel-body panel-body-sm" style="background:#DADCDE;">
								<div class="f12px">
			...
			<div class="highlight-area green">
				...
				<div class="marginT20 text-center">
					<a href="send_ad.asp" class="btn btn-sm btn-danger marginR10"><i class="fa fa-external-link"></i> 광고문자 보내기</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="modal-dialog type-primary">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="nexturl" value="/xclient/message/ad_duty.asp">
