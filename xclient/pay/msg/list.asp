				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="list.asp%3Fspkind=B&menu=02" class="fRed">연동요금안내</a></li>
						</ul>
					</li>
					<li class="dropdown">
	...
	<div class="site-position">
		...
		<span class="dropdown">
			...
			<ul class="dropdown-menu pull-right" role="menu">
				...
				<li id="pos_01"><a href="list.asp">요금안내</a></li>
			
				<li id="pos_05"><a href="../../service/proposal.asp">견적신청</a></li>
				<li id="pos_04"><a href="pay_list.asp">결제내역</a></li>
			</ul>
		</span>
	</div>
</div>
	...
	<div class="row">
		...
		<div class="panel panel-sm panel-success">
			...
			<div class="list-group">
				...
				<a href="list.asp" class="list-group-item" id="left_01">요금안내</a>
			
				<a href="../../service/proposal.asp" class="list-group-item" id="left_05">견적서신청</a>
				<a href="pay_list.asp" class="list-group-item" id="left_04">결제내역</a>
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="page-nav">
						<ul class="nav nav-pills ">
							<li id="tabOrderA" class="active"><a href="list.asp%3Fspkind=A" class="LMS"><i class="fa fa-user marginR5 hidden-xs"></i>일반회원</a></li>
							<li id="tabOrderB" class=""><a href="list.asp%3Fspkind=B&menu=01" class="MMS"><i class="fa fa-share-alt marginR5 hidden-xs"></i>연동회원</a></li>
						</ul>
					</div>
		...
		<div class="modal-dialog type-primary">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="nexturl" value="/xclient/pay/msg/list.asp">
