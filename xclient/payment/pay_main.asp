...
<head>
	...
	<title>쏜다넷 - 요금안내 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]</title>
	<meta name="title" content="쏜다넷 - 요금안내 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]">
	...
	<meta name="description" content="쏜다넷 - 요금안내 [단체문자보내기,단체문자발송,문자사이트,SMS보내기,컴퓨터문자메세지보내기,웹발신문자,LMS문자,KT문자,SKT문자,LGT문자,그림문자,포토문자,WEB발신,SMS서비스,장문문자,엑셀문자,PC문자]">
	<meta name="Subject" content="쏜다넷 - 요금안내 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]">
	...
	<meta property='og:title' content='쏜다넷 - 요금안내 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]'>
	<meta property='og:description' content='쏜다넷 - 요금안내 [단체문자보내기,단체문자발송,문자사이트,SMS보내기,컴퓨터문자메세지보내기,웹발신문자,LMS문자,KT문자,SKT문자,LGT문자,그림문자,포토문자,WEB발신,SMS서비스,장문문자,엑셀문자,PC문자]'>
...
<noscript>
	...
	<script type="text/javascript">
		...
		function viewItem(seq){
					...
					loginLayer("https://www.xonda.net/xclient/pay/msg/list.asp?spkind=A&menu=01");
	...
	.TR_CLICK{}
	.TR_CLICK:hover .price{color:#FF8000 !important;}
	.label-prod{
		background-color: #dddd; color:#333333;		
	}
	.label-prodA{
	...
	.label-prod,
	.label-prodA,
	.label-prodB{font-size:12px;}
	.common_dialog_msg{line-height:24px;}
	</style>
</head>
<body>
<!-- page info -->
<div id="page-info">
	<!-- page title -->
	<h1 class="page-title">요금안내</h1>

	<!-- page keywords -->
	<h2 class="page-keywords">대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자</h1>

	<!-- page description -->
	<h3 class="page-description">단체문자보내기,단체문자발송,문자사이트,SMS보내기,컴퓨터문자메세지보내기,웹발신문자,LMS문자,KT문자,SKT문자,LGT문자,그림문자,포토문자,WEB발신,SMS서비스,장문문자,엑셀문자,PC문자</h1>
</div>
<!-- navigation start -->
		...
		<div class="row">
			...
			<div class="collapse navbar-collapse bs-navbar-collapse" role="navigation" id="bs-navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						<a class="dropdown-toggle black" data-toggle="dropdown" data-id="menu-sms" data-flag="move" href="../message/sms.asp" id="topmenu_00">일반문자</a>
						<ul class="dropdown-menu" role="menu">
							<li><a href="../message/sms.asp">단문전송</a></li>
							<li><a href="../message/lms.asp">장문전송</a></li>
							<li><a href="../message/mms.asp">포토전송</a></li>
	
							<li><a href="javascript:openPopFree()" class="fRed">무료문자</a></li>
	
							<li class="divider"></li>
							<li><a href="../message/emoticon_sms.asp">단문이모티콘</a></li>
							<li><a href="../message/emoticon_lms.asp">장문이모티콘</a></li>
							<li class="divider"></li>
							<li><a href="../message/callback.asp" class="fRed">발신번호 등록안내</a></li>
	
						</ul>
					</li>
					<li class="dropdown">
						<a class="dropdown-toggle red" data-toggle="dropdown" data-id="menu-sms" data-flag="move" href="../message/sms_ad.asp" id="topmenu_01">광고문자</a>
						<ul class="dropdown-menu" role="menu">
							<li><a href="../message/sms_ad.asp">단문전송</a></li>
							<li><a href="../message/lms_ad.asp">장문전송</a></li>
							<li><a href="../message/mms_ad.asp">포토전송</a></li>
							<li class="divider"></li>
							<li><a href="../message/ad_duty.asp" class="fRed">광고문자 이용안내</a></li>
							<li><a href="../message/callback.asp" class="fRed">발신번호 등록안내</a></li>
...
<div id="bodyWrapper"><div class="container">
	<div class="site-position">
		<a href="../../index.asp">Home</a><i class="fa fa-angle-right"></i><a href="pay_main.asp">충전하기</a><i class="fa fa-angle-right"></i>
		<span class="dropdown">
			<a class="dropdown-toggle now" data-toggle="dropdown" href="#" id="curr_menu"></a>
			<ul class="dropdown-menu pull-right" role="menu">
			
				<li id="pos_01"><a href="../pay/msg/list.asp">요금안내</a></li>
			
				<li id="pos_05"><a href="../service/proposal.asp">견적신청</a></li>
				<li id="pos_04"><a href="../pay/msg/pay_list.asp">결제내역</a></li>
			</ul>
		</span>
	</div>
</div>
...
<div class="container">
	<div class="row">
		...
		<div class="panel panel-sm panel-success">
			<div class="panel-heading">
				<h4><i class="fa fa-krw marginR5"></i>요금안내</h4>
			</div>
			<div class="list-group">
			
				<a href="../pay/msg/list.asp" class="list-group-item" id="left_01">요금안내</a>
			
				<a href="../service/proposal.asp" class="list-group-item" id="left_05">견적서신청</a>
				<a href="../pay/msg/pay_list.asp" class="list-group-item" id="left_04">결제내역</a>
				<a href="../member/mymenu.asp%3Fopen=etax" class="list-group-item" id="left_03">전자세금계산서신청</a>
			</div>
		</div>
		...
		<div class="panel panel-callback">
			<div class="panel-body panel-body-sm text-center">
				...
				<div class="btn-group btn-group-justified marginT20" role="group">
					<a class="btn btn-sm btn-secondary" href="../message/callback.asp"><i class='fa fa-search marginR5 hidden-md'></i>등록안내</a>
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="page-nav">
						<ul class="nav nav-pills ">
							<li id="tabOrderA" class="active"><a href="../pay/msg/list.asp%3Fspkind=A" class="LMS"><i class="fa fa-user marginR5 hidden-xs"></i>일반회원</a></li>
							<li id="tabOrderB" class=""><a href="../pay/msg/list.asp%3Fspkind=B&menu=01" class="MMS"><i class="fa fa-share-alt marginR5 hidden-xs"></i>연동회원</a></li>
						</ul>
					</div>
					<i id="change-animation-type-example" class="fa fa-car-side fa-3x animation zoom-in" style="animation-iteration-count: infinite; animation-duration: 1000ms;"></i>
				</div>
			</div>
	...
	<div class="bs-callout bs-callout-danger">
		<h4 class="text-info">쏜다넷 요금안내 </h4>
		<p class="marginT20">쏜다넷에서 결제하시는 <b class="fGreen">일반회원</b>님들께 드리는 <span class="label label-danger f12px">3가지 특별 이벤트!!!</span></p>
		<ul class="check-list">
			<li><span class="label label-default f12px inline W80 marginR10">이벤트 하나!</span> 최대 <span class="label label-danger f12px bgStripes">45% 추가</span> 캐쉬를 드립니다!!</li>
			<li><span class="label label-default f12px inline W80 marginR10">이벤트 둘!</span> 회원가입 후 첫구매시 최대 <span class="label label-dark fLYellow f12px bgStripes">170% 추가</span> 캐쉬를 더 드립니다!!<br><span class='fGray'>(단, 첫구매 후 <a href="../member/qna_list.asp">마이메뉴▶1:1문의</a>에 첫구매 요청글을 남겨주셔야 적립 가능합니다.)</span></li>
			<li><span class="label label-default f12px inline W80 marginR10">이벤트 셋!</span> 매일매일 <span class="label label-danger f12px bgStripes">무료문자 3,000건</span> 지급 (9시/12시/18시 선착순 지급)</li>
		</ul>
	</div>

	<div class="">
		<div class="carousel xonda-carousel slide" data-ride="carousel" data-interval="5000" id="pay-carousel">
			<div class="carousel-inner">
				<div class="item slides active">
					<div class="slide-box slide-first slide-first-1" onclick="makeAlert('★첫구매 1+1★ 표시된 상품중\n하나를 골라 신청하세요.')">
						<div class="first-body">
							<img src="../images/event/01/double_banner_left_2.png" class="left"><img src="../images/event/01/double_banner_right_1.png" class="right">
						</div>
					</div>
				</div>
				<div class="item slides">
					<div class="slide-box slide-first slide-first-1" onclick="makeAlert('★첫구매 1+1★ 표시된 상품중\n하나를 골라 신청하세요.')">
						<div class="first-body">
							<span class="left"><b>30만원</b> 충전시</span><span class="right"><img src="../images/event/01/double_cash_30.png"></span>
						</div>
					</div>
				</div>
				<div class="item slides">
					<div class="slide-box slide-first slide-first-2" onclick="makeAlert('★첫구매 1+1★ 표시된 상품중\n하나를 골라 신청하세요.')">
						<div class="first-body">
							<img src="../images/event/01/double_banner_left_2.png" class="left"><img src="../images/event/01/double_banner_right_2.png" class="right">
						</div>
					</div>
				</div>
				<div class="item slides">
					<div class="slide-box slide-first slide-first-3" onclick="document.location.href='/xclient/customer/event.asp?code=02';">
						<div class="first-body">
							<span class="left"><b>300</b>만원, <b>500</b>만원</span><span class="right2"><img src="../images/event/02/gift_banner_left_2.png"></span>
						</div>
					</div>
				</div>
			</div> 
			...
			<a class="left carousel-control" href="#pay-carousel" role="button" data-slide="prev">
				<span class="icon-prev"></span>
			</a>
			<a class="right carousel-control" href="#pay-carousel" role="button" data-slide="next">
	...
	<div class="marginT20">
		<h4><i class="fa fa-check-circle marginR5"></i>결제 상품<small class="pull-right marginL5 hidden-xs"><i class="fa fa-info-circle marginR5"></i>상품금액과 건당금액은 부가세 별도입니다.</small></h4>
	</div>

	<div class="table-responsive">    
		<table class="table table-hover table-bordered">
			<thead>
				<tr class="gradient-success">
					<th class="text-center">선택</th>
					<th class="text-center">상품금액</th>
					<th class="text-center" colspan="2">첫구매 총 충전금액</th>
					<th class="text-center">단문건수 <i class="fa fa-question-circle cHand" data-toggle="popover" data-trigger="hover" data-placement="bottom" title="단문건수란?" data-content="총충전금액으로 <span class='fRed'>단문만</span> 전송하실때 전송가능한 예상건수입니다.<br><span class='fRed'>장문 또는 포토문자와 혼용시</span><br>달라질 수 있습니다."></i></th>
					<th class="text-center">장문건수 <i class="fa fa-question-circle cHand" data-toggle="popover" data-trigger="hover" data-placement="bottom" title="장문건수란?" data-content="총충전금액으로 <span class='fRed'>장문만</span> 전송하실때 전송가능한 예상건수입니다.<br><span class='fRed'>단문 또는 포토문자와 혼용시</span><br>달라질 수 있습니다."></i></th>
					<th class="text-center">포토건수 <i class="fa fa-question-circle cHand" data-toggle="popover" data-trigger="hover" data-placement="bottom" title="포토건수란?" data-content="총충전금액으로 <span class='fRed'>포토만</span> 전송하실때 전송가능한 예상건수입니다.<br><span class='fRed'>단문 또는 장문과 혼용시</span><br>달라질 수 있습니다."></i></th>
				</tr>
			</thead>

			<tbody class='f12px'>
				<!--LISTSTART-->
				<tr class="TR_CLICK bgLRed">
					<td class="text-center bgStripes"><input type="radio" name="itemseq" value="241" ></td>
					<td class="text-center bgStripes"><a href="javascript:viewItem(241)" class="price text-primary fBold">1,000,000원</a></td>
					<td class="text-right bg-warning">
						<span class="text-danger f11px">+ 650,000원</span><br>
						<b class="text-primary">1,650,000원</b>
					</td>
					<td class="text-center bg-warning price minW50"><span class="label label-danger price-rate">65%<img src="../images/up_arrow_y.gif" align="absmiddle"></span></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 19원">60,000</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 53.1원">21,428</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 189.7원">6,000</div></td>
					
				</tr>
				<!--/LISTEND--><!--LISTSTART-->
				<tr class="TR_CLICK ">
					<td class="text-center "><input type="radio" name="itemseq" value="240" ></td>
					<td class="text-center "><a href="javascript:viewItem(240)" class="price text-primary fBold">500,000원</a></td>
					<td class="text-right bg-warning">
						<span class="text-danger f11px">+ 300,000원</span><br>
						<b class="text-primary">800,000원</b>
					</td>
					<td class="text-center bg-warning price minW50"><span class="label label-default price-rate">60%<img src="../images/up_arrow_y.gif" align="absmiddle"></span></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 19.6원">29,090</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 55원">10,389</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 196.5원">2,909</div></td>
					
				</tr>
				<!--/LISTEND--><!--LISTSTART-->
				<tr class="TR_CLICK bg-success">
					<td class="text-center bgStripes"><input type="radio" name="itemseq" value="239" ></td>
					<td class="text-center bgStripes"><a href="javascript:viewItem(239)" class="price text-primary fBold">300,000원</a><div class='fBold fRed text-center marginT5'><b class='label-BEST'><i class='fa fa-star'></i>첫구매 1+1<i class='fa fa-star'></i></b></div></td>
					<td class="text-right bg-warning">
						<span class="text-danger f11px">+ 510,000원</span><br>
						<b class="text-primary">810,000원</b>
					</td>
					<td class="text-center bg-warning price minW50"><span class="label label-dark fLYellow price-rate">170%<img src="../images/up_arrow_y.gif" align="absmiddle"></span><div class='fBold fRed text-center marginT5'><b class='label-BEST'><i class='fa fa-star'></i>첫구매 1+1<i class='fa fa-star'></i></b></div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 20.4원">29,454</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 57원">10,519</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 203.8원">2,945</div></td>
					
				</tr>
				<!--/LISTEND--><!--LISTSTART-->
				<tr class="TR_CLICK bg-success">
					<td class="text-center bgStripes"><input type="radio" name="itemseq" value="238" ></td>
					<td class="text-center bgStripes"><a href="javascript:viewItem(238)" class="price text-primary fBold">200,000원</a><div class='fBold fRed text-center marginT5'><b class='label-BEST'><i class='fa fa-star'></i>첫구매 1+1<i class='fa fa-star'></i></b></div></td>
					<td class="text-right bg-warning">
						<span class="text-danger f11px">+ 320,000원</span><br>
						<b class="text-primary">520,000원</b>
					</td>
					<td class="text-center bg-warning price minW50"><span class="label label-dark fLYellow price-rate">160%<img src="../images/up_arrow_y.gif" align="absmiddle"></span><div class='fBold fRed text-center marginT5'><b class='label-BEST'><i class='fa fa-star'></i>첫구매 1+1<i class='fa fa-star'></i></b></div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 21.2원">18,909</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 59.2원">6,753</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 211.6원">1,890</div></td>
					
				</tr>
				<!--/LISTEND--><!--LISTSTART-->
				<tr class="TR_CLICK bg-success">
					<td class="text-center bgStripes"><input type="radio" name="itemseq" value="237" ></td>
					<td class="text-center bgStripes"><a href="javascript:viewItem(237)" class="price text-primary fBold">100,000원</a><div class='fBold fRed text-center marginT5'><b class='label-BEST'><i class='fa fa-star'></i>첫구매 1+1<i class='fa fa-star'></i></b></div></td>
					<td class="text-right bg-warning">
						<span class="text-danger f11px">+ 150,000원</span><br>
						<b class="text-primary">250,000원</b>
					</td>
					<td class="text-center bg-warning price minW50"><span class="label label-dark fLYellow price-rate">150%<img src="../images/up_arrow_y.gif" align="absmiddle"></span><div class='fBold fRed text-center marginT5'><b class='label-BEST'><i class='fa fa-star'></i>첫구매 1+1<i class='fa fa-star'></i></b></div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 22원">9,090</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 61.6원">3,246</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 220.3원">909</div></td>
					
				</tr>
				<!--/LISTEND--><!--LISTSTART-->
				<tr class="TR_CLICK ">
					<td class="text-center "><input type="radio" name="itemseq" value="236" ></td>
					<td class="text-center "><a href="javascript:viewItem(236)" class="price text-primary fBold">50,000원</a></td>
					<td class="text-right bg-warning">
						<span class="text-danger f11px">+ 20,000원</span><br>
						<b class="text-primary">70,000원</b>
					</td>
					<td class="text-center bg-warning price minW50"><span class="label label-default price-rate">40%<img src="../images/up_arrow_y.gif" align="absmiddle"></span></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 22.9원">2,545</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 64.2원">909</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 229.4원">254</div></td>
					
				</tr>
				<!--/LISTEND--><!--LISTSTART-->
				<tr class="TR_CLICK bg-success">
					<td class="text-center bgStripes"><input type="radio" name="itemseq" value="235" ></td>
					<td class="text-center bgStripes"><a href="javascript:viewItem(235)" class="price text-primary fBold">30,000원</a><div class='fBold fRed text-center marginT5'><b class='label-BEST'><i class='fa fa-star'></i>첫구매 1+1<i class='fa fa-star'></i></b></div></td>
					<td class="text-right bg-warning">
						<span class="text-danger f11px">+ 39,000원</span><br>
						<b class="text-primary">69,000원</b>
					</td>
					<td class="text-center bg-warning price minW50"><span class="label label-dark fLYellow price-rate">130%<img src="../images/up_arrow_y.gif" align="absmiddle"></span><div class='fBold fRed text-center marginT5'><b class='label-BEST'><i class='fa fa-star'></i>첫구매 1+1<i class='fa fa-star'></i></b></div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 23.9원">2,509</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 67원">896</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 240원">250</div></td>
					
				</tr>
				<!--/LISTEND--><!--LISTSTART-->
				<tr class="TR_CLICK ">
					<td class="text-center "><input type="radio" name="itemseq" value="234" ></td>
					<td class="text-center "><a href="javascript:viewItem(234)" class="price text-primary fBold">20,000원</a></td>
					<td class="text-right bg-warning">
						<span class="text-danger f11px">+ 6,400원</span><br>
						<b class="text-primary">26,400원</b>
					</td>
					<td class="text-center bg-warning price minW50"><span class="label label-default price-rate">32%<img src="../images/up_arrow_y.gif" align="absmiddle"></span></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 24.6원">960</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 69원">342</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 246.9원">96</div></td>
					
				</tr>
				<!--/LISTEND--><!--LISTSTART-->
				<tr class="TR_CLICK ">
					<td class="text-center "><input type="radio" name="itemseq" value="233" ></td>
					<td class="text-center "><a href="javascript:viewItem(233)" class="price text-primary fBold">10,000원</a></td>
					<td class="text-right bg-warning">
						<span class="text-danger f11px">+ 3,000원</span><br>
						<b class="text-primary">13,000원</b>
					</td>
					<td class="text-center bg-warning price minW50"><span class="label label-default price-rate">30%<img src="../images/up_arrow_y.gif" align="absmiddle"></span></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 25원">472</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 70원">168</div></td>
					<td class="text-right text-primary"><div data-toggle="tooltip" data-html="true" title="건당 250원">47</div></td>
	...
	<div class="text-center">
		<button type='button' class="btn btn-md btn-primary" onclick="viewItem(0);">충전하기</button>
	</div>
	</form>


					<div class="panel panel-info marginT20">
						<div class="panel-body f12px bgLGray">
							<p><i class="fa fa-angle-right"></i> 각 상품의 금액은 부가세 별도 가격입니다. </p>
							<p><i class="fa fa-angle-right"></i> 사업자에 한하여 <b>전자세금계산서</b> 발행이 가능합니다. (거래시기가 속하는 달의 다음달 10일 까지 신청)</p>
							<p class="paddingL10">- <b>무통장입금 :</b> 첫거래시 1:1 게시판에 신청, 이후거래분부터 자동발행됨 (단, 사업자등록증 변동시 재신청)</p>
							<p class="paddingL10">- <b>가상계좌,휴대폰결제 :</b> 매결제시마다 1:1 게시판에 신청</p>
							<p><i class="fa fa-angle-right"></i> 무통장입금시 <b>현금영수증</b>은 1:1 게시판에 글을 남겨주시면 발행해드립니다. (거래당일 또는 다음날까지 신청)</p>
			
						<!-- 일반회원 -->
							<p><i class="fa fa-angle-right"></i> 쏜다넷 서비스는 일반회원(개인,기업) 및 연동회원(기업형ASP이용회원) 방식으로 이용이 가능합니다.</p>
							<p><i class="fa fa-angle-right"></i> 일반회원은 연동회원 요금으로 결제하실 수 없습니다.</p>
...
<div class="main-banner-bar type1">
	<div class="container">
		<div class="sub-title"><span class="label label-default">25년 운영노하우</span></div>
		<div class="title">빠르고 <i class="fa fa-flash"></i> 확실한 <i class="fa fa-flash"></i> 대량전송</div>
		<div class="desc">쏜다넷이 더욱 빨라졌습니다.</div>
		<div class="box">
		
			<a class="btn btn-danger" href="../member/joinstep1.asp">무료 회원가입</a>
		...
		<div class="modal-dialog type-primary">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="nexturl" value="/xclient/payment/pay_main.asp">
