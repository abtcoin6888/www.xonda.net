...
<head>
	...
	<title>쏜다넷 - 이벤트 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]</title>
	<meta name="title" content="쏜다넷 - 이벤트 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]">
	...
	<meta name="description" content="쏜다넷 - 이벤트 [단체문자보내기,단체문자발송,문자사이트,SMS보내기,컴퓨터문자메세지보내기,웹발신문자,LMS문자,KT문자,SKT문자,LGT문자,그림문자,포토문자,WEB발신,SMS서비스,장문문자,엑셀문자,PC문자]">
	<meta name="Subject" content="쏜다넷 - 이벤트 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]">
	...
	<meta property='og:title' content='쏜다넷 - 이벤트 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]'>
	<meta property='og:description' content='쏜다넷 - 이벤트 [단체문자보내기,단체문자발송,문자사이트,SMS보내기,컴퓨터문자메세지보내기,웹발신문자,LMS문자,KT문자,SKT문자,LGT문자,그림문자,포토문자,WEB발신,SMS서비스,장문문자,엑셀문자,PC문자]'>
...
function searchNoticeList(){document.frmSearch.page.value=1,loadNoticeList()}function loadNoticeList(){var e=serializeGETData("frmSearch");loadURL("POST","/xclient/customer/notice_data.asp",e,"divNoticeList")}function changeNoticeType(e,t){document.frmSearch.search_type.value=e,$(t).parents(".dropdown").find(".dropdown-toggle").find(".title").html($(t).text())}function changeNoticePage(e){document.frmSearch.page.value=e,loadNoticeList()}function moveNoticeView(e){var t=serializeGETData("frmSearch");document.location.href="/xclient/customer/notice_view.asp?"+t+"&seq="+e}function moveNoticeList(e){var t=serializeGETData("frmSearch");document.location.href="/xclient/customer/notice_list.asp?"+t}function searchFAQList(){document.frmSearch.page.value=1,loadFAQList()}function loadFAQList(){var e=serializeGETData("frmSearch");loadURL("POST","/xclient/customer/faq_data.asp",e,"divFAQList")}function changeFAQCate(e,t){document.frmSearch.search_cate.value=e,$(t).parents(".dropdown").find(".dropdown-toggle").find(".title").html($(t).text())}function changeFAQType(e,t){document.frmSearch.search_type.value=e,$(t).parents(".dropdown").find(".dropdown-toggle").find(".title").html($(t).text())}function changeFAQPage(e){document.frmSearch.page.value=e,loadFAQList()}function moveFAQView(e){var t=serializeGETData("frmSearch");document.location.href="/xclient/customer/faq_view.asp?"+t+"&seq="+e}function moveFAQList(e){var t=serializeGETData("frmSearch");document.location.href="/xclient/customer/faq_list.asp?"+t}function searchTipList(){document.frmSearch.page.value=1,loadTipList()}function loadTipList(){var e=serializeGETData("frmSearch");loadURL("POST","/xclient/customer/tip_data.asp",e,"divTipList")}function changeTipType(e,t){document.frmSearch.search_type.value=e,$(t).parents(".dropdown").find(".dropdown-toggle").find(".title").html($(t).text())}function changeTipPage(e){document.frmSearch.page.value=e,loadTipList()}function moveTipView(e){var t=serializeGETData("frmSearch");document.location.href="/xclient/customer/tip_view.asp?"+t+"&seq="+e}function moveTipList(e){var t=serializeGETData("frmSearch");document.location.href="/xclient/customer/tip_list.asp?"+t}function searchSnsList(){document.frmSearch.page.value=1,loadSnsList()}function loadSnsList(){var e=serializeGETData("frmSearch");document.location.href="./sns_list.asp?"+e}function changeSnsType(e,t){document.frmSearch.search_type.value=e,$(t).parents(".dropdown").find(".dropdown-toggle").find(".title").html($(t).text())}function changeSnsPage(e){document.frmSearch.page.value=e,loadSnsList()}
	...
	function paymentStartA(seq){
		
			loginLayer("/xclient/customer/event.asp?code=01");
		
	}
	function paymentStartB(seq){
		
			loginLayer("/xclient/customer/event.asp?code=01");
		
	}
	function movePayment(){
			menuURL("https://www.xonda.net/xclient/payment/pay_main.asp");
	}
	...
	<div class="container hidden-xs">
		<div class="row">
			<div class="navbar-quick">
				...
				<a href="notice_list.asp"><i class="fa fa-volume-down marginR5"></i>고객센터</a>
...
<div id="bodyWrapper"><div class="container">
	<div class="site-position">
		<a href="../../index.asp">Home</a><i class="fa fa-angle-right"></i><a href="event.asp">이벤트</a><i class="fa fa-angle-right"></i>
		<span class="dropdown">
			<a class="dropdown-toggle now" data-toggle="dropdown" href="#" id="curr_menu"></a>
			<ul class="dropdown-menu pull-right" role="menu">
				<li id="pos_01"><a href="event.asp%3Fcode=01">신규회원 첫구매 이벤트</a>
				<li id="pos_02"><a href="event.asp%3Fcode=02">상품권 추가증정 이벤트</a>
			</ul>
		</span>
	</div>
</div>
	...
	<div class="row">
		...
		<div class="panel panel-sm panel-success">
			<div class="panel-heading">
				<h4><i class="fa fa-volume-down marginR5"></i>이벤트</h4>
			</div>
			<div class="list-group">
				<a href="event.asp%3Fcode=01" class="list-group-item" id="left_01">신규회원 <span class="label label-danger">첫구매</span> 이벤트</a>
			</div>
			<div class="list-group">
				<a href="event.asp%3Fcode=02" class="list-group-item" id="left_02">상품권 <span class="label label-danger">추가증정</span> 이벤트</a>
			</div>
...
.event-01{
	margin-top:10px;
	background:#0150A9 url("../images/event/01/double_bg.png") no-repeat center/contain;
	text-align:center;
}
...
@media (max-width: 449px) {
	...
	.event-01 img{width:80%;}
}
</style>
<div class="bs-callout bs-callout-danger">
	<h4 class="text-info" style="margin-bottom:0 !important">신규회원 <span class="label label-danger">첫구매</span> 이벤트</h4>
</div>
<div class="event-01">
	<img src="../images/event/01/double_body_pc.png">
</div>
<div class="row">
	<div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 text-center">
		<a href="javascript:paymentStartA(235)"><img src="../images/event/01/double_item1_3.png" style="max-width:100%"></a>
	</div>
	<div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 text-center">
		<a href="javascript:paymentStartA(237)"><img src="../images/event/01/double_item2.png" style="max-width:100%"></a>
	</div>
	<div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 text-center">
		<a href="javascript:paymentStartA(238)"><img src="../images/event/01/double_item3.png" style="max-width:100%"></a>
	</div>
	<div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 text-center">
		<a href="javascript:paymentStartA(239)"><img src="../images/event/01/double_item4.png" style="max-width:100%"></a>
	</div>
</div>
<div class="marginT20 paddingT20 text-center" style="border-top:5px solid #777777">
	<a href="../member/joinstep1.asp" class="btn btn-sm btn-primary">무료회원가입</a>
	&nbsp;
	<a href="../service/pay_chart.asp" class="btn btn-sm btn-dark fLYellow">더블적립신청</a>
</div>
<div class="marginT30 alert alert-default">
	<ul class="check-xs-list">
		<li>가입 후 결제이력이 없는 회원만 참여 가능한 이벤트입니다.</li>
		<li>일반회원에 한하여 1회만 참여가능합니다. (연동회원은 연동회원 전용요금제 이용가능)</li>
		<li>결제금액은 부가세 별도입니다.</li>
		<li>이벤트 상품으로 충전된 캐쉬는 환불 및 이관이 불가합니다.</li>
	</ul>
</div>
		</div>
	</div>
		...
		<div class="modal-dialog type-primary">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="nexturl" value="/xclient/customer/event.asp">
