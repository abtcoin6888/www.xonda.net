...
<head>
	...
	<title>쏜다넷 - 전송TIP [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]</title>
	<meta name="title" content="쏜다넷 - 전송TIP [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]">
	...
	<meta name="description" content="쏜다넷 - 전송TIP [단체문자보내기,단체문자발송,문자사이트,SMS보내기,컴퓨터문자메세지보내기,웹발신문자,LMS문자,KT문자,SKT문자,LGT문자,그림문자,포토문자,WEB발신,SMS서비스,장문문자,엑셀문자,PC문자]">
	<meta name="Subject" content="쏜다넷 - 전송TIP [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]">
	...
	<meta property='og:title' content='쏜다넷 - 전송TIP [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]'>
	<meta property='og:description' content='쏜다넷 - 전송TIP [단체문자보내기,단체문자발송,문자사이트,SMS보내기,컴퓨터문자메세지보내기,웹발신문자,LMS문자,KT문자,SKT문자,LGT문자,그림문자,포토문자,WEB발신,SMS서비스,장문문자,엑셀문자,PC문자]'>
	...
	<div class="">
		...
		<div class="col-md-9 col-sm-12 col-xs-12">
			<div class="bs-callout bs-callout-danger">
				<h4 class="text-info">전송TIP</h4>
				<p><small>문자전송시 유용한 정보를 제공합니다.</small></p>
			</div>
			<div class="row">
				<div class="col-lg-6 col-md-7 col-sm-7 col-xs-12">
					...
					<div class="input-group input-group-sm">
						<div class="input-group-btn dropdown">
							<button type="button" class="btn btn-default btn-sm dropdown-toggle dropdown-toggle-btn" data-toggle="dropdown" data-default="제목검색" aria-haspopup="true" aria-expanded="false" ><span class='title'>제목검색</span><span class="caret"></span></button><ul class="dropdown-menu" data-container="body"><li><a onclick="changeTipType('TITLE',$(this));" class="dropdown-item f12px ellipsis">제목검색</a></li><li><a onclick="changeTipType('CONTENTS1',$(this));" class="dropdown-item f12px ellipsis">내용검색</a></li></ul><input type="hidden" name="search_type" value="TITLE">
						</div>
						<input type="text" name="search_text" id="txt_search_text" class="form-control" value="" maxlength="10">
						<div class="input-group-btn">
							<button type="button" class="btn btn-sm btn-success marginL5" onclick="searchTipList()"><i class="fa fa-search hidden-xs marginR5"></i>검색</button>
						</div>
					</div>
					</form>
				</div>
			...
			<!-- 상세내역 -->
			<div id="divTipList" class="marginT10" style="min-height:420px;"></div>
		</div>
	</div>
</div>
		...
		<div class="modal-dialog type-primary">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="nexturl" value="/xclient/customer/tip_list.asp">
