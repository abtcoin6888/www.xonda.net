...
<head>
	...
	<title>쏜다넷 - 로그인 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]</title>
	<meta name="title" content="쏜다넷 - 로그인 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]">
	...
	<meta name="description" content="쏜다넷 - 로그인 [단체문자보내기,단체문자발송,문자사이트,SMS보내기,컴퓨터문자메세지보내기,웹발신문자,LMS문자,KT문자,SKT문자,LGT문자,그림문자,포토문자,WEB발신,SMS서비스,장문문자,엑셀문자,PC문자]">
	<meta name="Subject" content="쏜다넷 - 로그인 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]">
	...
	<meta property='og:title' content='쏜다넷 - 로그인 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]'>
	<meta property='og:description' content='쏜다넷 - 로그인 [단체문자보내기,단체문자발송,문자사이트,SMS보내기,컴퓨터문자메세지보내기,웹발신문자,LMS문자,KT문자,SKT문자,LGT문자,그림문자,포토문자,WEB발신,SMS서비스,장문문자,엑셀문자,PC문자]'>
		...
		<div class="row">
			...
			<div class="collapse navbar-collapse bs-navbar-collapse" role="navigation" id="bs-navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" data-id="menu-addr" data-flag="menu" href="address.asp" id="topmenu_03">주소록</a>
						<ul class="dropdown-menu" role="menu">
	...
	<div class="site-position">
		...
		<span class="dropdown">
			...
			<ul class="dropdown-menu pull-right" role="menu">
				<li id="pos_01"><a href="../member/joinstep1.asp">회원가입</a></li>
				<li id="pos_02"><a href="../member/findidpw.asp">아이디/비밀번호찾기</a></li>
				<li id="pos_03"><a href="../member/login.asp">로그인</a></li>
	...
	<div class="row">
		...
		<div class="panel panel-sm panel-success">
			...
			<div class="list-group">
				<a href="../member/joinstep1.asp" class="list-group-item" id="left_01">회원가입</a>
				<a href="../member/findidpw.asp" class="list-group-item" id="left_02">아이디/비밀번호찾기</a>
				<a href="../member/login.asp" class="list-group-item" id="left_03">로그인</a>
	...
	<div class="">
		...
		<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 paddingB20">
			...
			<div class="bs-callout bs-callout-danger">
				<h4 class="text-info">LOGIN <small class="marginL10 f11px">로그인 후 이용하실 수 있습니다.</small></h4>
				<p class="text-danger hidden-xs marginT20"><i class="fa fa-exclamation-triangle marginR5"></i><small>로그인 10회 이상 실패 시 로그인이 제한됩니다.</small></p>
				<p class="text-danger hidden-xs"><i class="fa fa-question marginR5"></i><small>사이트 이용문의는 고객센터로 연락주세요</small></p>
				<p class="text-danger hidden-xs"><i class="fa fa-phone marginR5"></i><small>02-2646-7280</small></p>
			</div>
			<div class="marginT20 hidden-xs">
				<p>&nbsp;</p>
			</div>
			<div>
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
					<form class="" name="frmLogin" target="frameHidden" method="post" action="https://www.xonda.net/xclient/member/login_proc.asp" onsubmit="return false">
					<input type="hidden" name="nexturl" value="https://www.xonda.net/xclient/address/address_export.asp">
					<input type="hidden" name="https" value="ON">
					<div class="form-group">
						<label for="loginid">아이디</label>
						<input type="text" name="loginid" value="" id="loginid" class="form-control" placeholder="아이디">
					</div>
					<div class="form-group marginB10">
						<label for="password">비밀번호</label>
						<input type="password" name="loginpass" id="loginpass" class="form-control" placeholder="비밀번호">
					</div>
					<div class="form-group marginB10">
						<input type="checkbox" name="idsave" id="idsave1" value="1"  /><label for="idsave1" class="f12px fNormal marginL5">아이디 기억하기</label> 
					</div>
					</form>
					<div class="form-group">
						<button type="button" class="btn btn-md btn-primary btn-block" onclick="LoginOk()">로그인</button>
					</div>
					<div class="form-group">
						<span class="pull-left"><a class="btn btn-sm btn-danger" href="../member/joinstep1.asp">회원가입</a></span>
						<span class="pull-right"><a class="btn btn-sm btn-default" href="../member/findidpw.asp">ID / PW 찾기</a></span>
					</div>
				</div>
				<div class="col-lg-2 col-md-2 hidden-sm hidden-xs">
					&nbsp;
			...
			function LoginOk(){
				if($("#loginid").pval() == ""){
					makeAlert("아이디를 입력하세요.", funcFocus(document.frmLogin.loginid));
				}else if($("#loginpass").pval() == ""){
					makeAlert("비밀번호를 입력하세요.", funcFocus(document.frmLogin.loginpass));
				}else{
...
<div class="main-banner-bar type3">
	<div class="container">
		...
		<div class=""><!-- BANNER / 수신거부 -->
<div class="main-banner-bar type4">
	<div class="container">
		<div class="title">080번호 <b>무료제공</b> !!</div>
		<div class="desc">광고문자에 필요한 수신거부번호를 추가비용없이 이용하세요.</div>
		<div class="box">
			<a class="btn btn-danger" href="../message/ad_duty.asp">광고문자 표기의무 사항 안내</a>
		</div>
	</div>
</div>
</div>
		...
		<div class="modal-dialog type-primary">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="nexturl" value="/xclient/member/login.asp?nexturl=https%3A%2F%2Fwww%2Exonda%2Enet%2Fxclient%2Faddress%2Faddress%5Fexport%2Easp">
					<input type="hidden" name="https" value="ON">
					<div class="form-group">
