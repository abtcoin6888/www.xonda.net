		...
		<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 paddingB20">
			...
			<div>
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
					...
					<input type="hidden" name="nexturl" value="https://www.xonda.net/xclient/member/use_list.asp">
					...
					<div class="form-group">
						<span class="pull-left"><a class="btn btn-sm btn-danger" href="joinstep1.asp">회원가입</a></span>
						<span class="pull-right"><a class="btn btn-sm btn-default" href="findidpw.asp">ID / PW 찾기</a></span>
					</div>
				</div>
				<div class="col-lg-2 col-md-2 hidden-sm hidden-xs">
					&nbsp;
		...
		<div class="modal-dialog type-primary">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="nexturl" value="/xclient/member/login.asp?nexturl=https%3A%2F%2Fwww%2Exonda%2Enet%2Fxclient%2Fmember%2Fuse%5Flist%2Easp">
					<input type="hidden" name="https" value="ON">
					<div class="form-group">
