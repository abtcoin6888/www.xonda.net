...
<head>
	...
	<title>쏜다넷 - 아이디/비밀번호찾기 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]</title>
	<meta name="title" content="쏜다넷 - 아이디/비밀번호찾기 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]">
	...
	<meta name="description" content="쏜다넷 - 아이디/비밀번호찾기 [단체문자보내기,단체문자발송,문자사이트,SMS보내기,컴퓨터문자메세지보내기,웹발신문자,LMS문자,KT문자,SKT문자,LGT문자,그림문자,포토문자,WEB발신,SMS서비스,장문문자,엑셀문자,PC문자]">
	<meta name="Subject" content="쏜다넷 - 아이디/비밀번호찾기 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]">
	...
	<meta property='og:title' content='쏜다넷 - 아이디/비밀번호찾기 [대량문자,단체문자전송,단체문자사이트,문자전송,대량문자보내기,단체문자,단체문자발송,무료문자,문자사이트,문자발송발송사이트,인터넷으로문자보내기,문자보내기,대량문자전송,선거문자]'>
	<meta property='og:description' content='쏜다넷 - 아이디/비밀번호찾기 [단체문자보내기,단체문자발송,문자사이트,SMS보내기,컴퓨터문자메세지보내기,웹발신문자,LMS문자,KT문자,SKT문자,LGT문자,그림문자,포토문자,WEB발신,SMS서비스,장문문자,엑셀문자,PC문자]'>
...
<noscript>
	...
	<script type="text/javascript">
	/* findidpw.min.js | Yoon | devholic.net */
function changeChkGubun(e,n){document.frmID.chkGubun.value=e,$(n).parents(".dropdown").find(".dropdown-toggle").find(".title").html($(n).text()),changeInfoID()}function changeChkAuthID(e,n){document.frmID.chkAuth.value=e,$(n).parents(".dropdown").find(".dropdown-toggle").find(".title").html($(n).text()),changeInfoID()}function changeChkAuthPW(e,n){document.frmPW.chkAuth.value=e,$(n).parents(".dropdown").find(".dropdown-toggle").find(".title").html($(n).text()),changeInfoPW()}function changeInfoID(){var e=document.frmID,n=e.chkAuth.value,t=e.chkGubun.value;"1"==n?$("#chkValueID").attr("placeholder","휴대폰번호를 입력하세요."):"2"==n?$("#chkValueID").attr("placeholder","이메일주소를 입력하세요."):"M"==n?"2"==t?$("#textFINDID").html('<i class="fa fa-check"></i> 담당자 명의의 휴대폰으로 아이디를 찾습니다.'):$("#textFINDID").html('<i class="fa fa-check"></i> 본인 명의의 휴대폰으로 아이디를 찾습니다.'):"I"==n&&$("#textFINDID").html('<i class="fa fa-check"></i> 본인 명의의 아이핀으로 아이디를 찾습니다.')}function changeInfoPW(){var e=document.frmPW.chkAuth.value;"1"==e?$("#chkValuePW").attr("placeholder","휴대폰번호를 입력하세요."):"2"==e?$("#chkValuePW").attr("placeholder","이메일주소를 입력하세요."):"M"==e?$("#textFINDPW").html('<i class="fa fa-check"></i> 휴대폰 인증 후 해당 휴대폰으로 재발급됩니다.'):"I"==e&&$("#textFINDPW").html('<i class="fa fa-check"></i> 아이핀 인증 후 가입자 휴대폰으로 재발급됩니다.')}function FindID(){var e=document.frmID,n=e.kind.value,t="FINDID",u="",a="",c="",r="",l="";if("1"==n){if(u=e.chkGubun.value,a=$("#chkNameID").pval(),c=e.chkAuth.value,r=$("#chkValueID").pval(),""==u)return void makeAlert("가입유형을 선택해주세요.");if(""==a)return void makeAlert("가입자명을 입력해주세요.");if(""==c)return void makeAlert("인증방법을 선택해주세요.");if("1"==c){var i=(r=r.replaceAll("-","")).length;if(i<10||i>11)return void makeAlert("회원가입시 등록된 휴대폰번호를 정확히 입력해주세요.");var h=r.substring(0,3),k=r.substring(3,i-4),m=r.substring(i-4);if(!validateHP(h,k,m))return void makeAlert("회원가입시 등록된 휴대폰번호를 정확히 입력해주세요.");r=h+""+k+m}else if("2"==c&&!validateEmail(r))return void makeAlert("회원가입시 등록된 이메일주소를 정확히 입력해주세요.");makeConfirm("가입유형, 가입자명, 인증정보가 정확히 일치하는 계정을 검색합니다.\n\n검색된 결과가 있을 경우\n<span class='fBlue fBold'>"+l+"("+r+")로 아이디가 발송</span>됩니다.\n\n계속하시겠습니까?",(function(){var e=execURL("POST","/xclient/member/findidpw_proc.asp","kind="+n+"&chkType="+t+"&chkGubun="+u+"&chkName="+escape(a)+"&chkAuth="+c+"&chkValue="+escape(r)),l=e.substring(0,4),i=e.substring(5);"0000"==l?makeAlert(i):makeAlert("["+l+"] "+i)}))}else{if(u=e.chkGubun.value,c=e.chkAuth.value,""==u)return void makeAlert("가입유형을 선택해주세요.");if(""==c)return void makeAlert("인증방법을 선택해주세요.");l="M"==c?"본인인증을 거친 계정에 한하여 조회가 가능합니다.\n\n휴대폰인증을 진행하시겠습니까?":"본인인증을 거친 계정에 한하여 조회가 가능합니다.\n\n아이핀인증을 진행하시겠습니까?",makeConfirm(l,(function(){document.frmAuth.chkType.value=t,document.frmAuth.chkGubun.value=u,checkAuthType(c)}))}}function FindPW(){var e=document.frmPW,n=e.kind.value,t="FINDPW",u="",a="",c="",r="",l="";if("1"==n){if(u=$("#chkGubunPW").pval(),a=$("#chkNamePW").pval(),c=e.chkAuth.value,r=$("#chkValuePW").pval(),""==u)return void makeAlert("아이디를 입력해주세요.");if(""==a)return void makeAlert("가입자명을 입력해주세요.");if(""==c)return void makeAlert("인증방법을 선택해주세요.");if(l="1"==c?"휴대폰번호":"이메일주소",""==r)return void makeAlert("회원가입시 등록된 "+l+"를 입력해주세요.");if("1"==c){var i=(r=r.replaceAll("-","")).length;if(i<10||i>11)return void makeAlert("휴대폰번호를 정확히 입력해주세요.");var h=r.substring(0,3),k=r.substring(3,i-4),m=r.substring(i-4);if(!validateHP(h,k,m))return void makeAlert("회원가입시 등록된 휴대폰번호를 정확히 입력해주세요.");r=h+""+k+m}else if("2"==c&&!validateEmail(r))return void makeAlert("회원가입시 등록된 이메일주소를 정확히 입력해주세요.");makeConfirm("아이디, 가입자명, 인증정보가 정확히 일치하는 계정을 검색합니다.\n\n검색된 결과가 있을 경우\n<span class='fBlue fBold'>"+l+"("+r+")로 임시비밀번호가 발송</span>됩니다.\n\n계속하시겠습니까?",(function(){var e=execURL("POST","/xclient/member/findidpw_proc.asp","kind="+n+"&chkType="+t+"&chkGubun="+escape(u)+"&chkName="+escape(a)+"&chkAuth="+c+"&chkValue="+escape(r)),l=e.substring(0,4),i=e.substring(5);"0000"==l?makeAlert(i):makeAlert("["+l+"] "+i)}))}else{if(u=$("#chkGubunPW2").pval(),c=e.chkAuth.value,""==u)return void makeAlert("아이디를 입력해주세요.");if(""==c)return void makeAlert("인증방법을 선택해주세요.");l="M"==c?"휴대폰본인인증을 진행합니다.\n\n본인인증이 완료되면 <span class='fBlue fBold'>인증받으신 휴대폰번호로 임시비밀번호가 발급됩니다.</span>\n\n계속하시겠습니까?":"아이핀인증을 진행합니다.\n\n본인인증이 완료되면 <span class='fBlue fBold'>회원가입시 등록된 휴대폰번호로 임시비밀번호가 발급됩니다.</span>\n\n계속하시겠습니까?",makeConfirm(l,(function(){document.frmAuth.chkType.value=t,document.frmAuth.chkGubun.value="1",checkAuthType(c)}))}}function checkAuthType(e){var n=document.frmAuth;"M"==e?(n.chkAuth.value=e,n.action="/xclient/member/checkplus_main.asp",n.submit()):(n.chkAuth.value=e,n.action="/xclient/member/ipin_main.asp",n.submit())}function AuthResult(e,n,t,u){if("0000"==e)if("FINDID"==n){var a=document.frmID;chkGubun=a.chkGubun.value,t=a.chkAuth.value;var c=(l=execURL("POST","/xclient/member/findidpw_proc.asp","kind=2&chkType="+n+"&chkGubun="+chkGubun+"&chkAuth="+t+"&chkValue="+encodeURIComponent(u))).substring(0,4),r=l.substring(5);"0000"==c?makeAlert(r):makeAlert("["+c+"] "+r)}else{if("FINDPW"!=n)return void makeAlert("처리할 수 없습니다.");a=document.frmPW;chkGubun=a.chkGubun.value,t=a.chkAuth.value;var l;c=(l=execURL("POST","/xclient/member/findidpw_proc.asp","kind=2&chkType="+n+"&chkGubun="+escape(chkGubun)+"&chkAuth="+t+"&chkValue="+encodeURIComponent(u))).substring(0,4),r=l.substring(5);"0000"==c?makeAlert(r):makeAlert("["+c+"] "+r)}else makeAlert("본인인증에 실패했습니다.")}function PopupGuide(){openCommonPopup("Tip1")}
...
<div id="page-info">
	<!-- page title -->
	<h1 class="page-title">아이디/비밀번호찾기</h1>
...
<div id="topNavi" class="navbar navbar-xonda navbar-fixed-top row" role="banner">
		...
		<div class="row">
			...
			<div class="collapse navbar-collapse bs-navbar-collapse" role="navigation" id="bs-navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" data-id="menu-mymenu" data-flag="menu" href="mymenu.asp" id="topmenu_07">마이메뉴</a>
						<ul class="dropdown-menu" role="menu">
	...
	<div class="logoff">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<a class="btn btn-xs btn-danger marginL5" href="joinstep1.asp"><i class="fa fa-pencil marginR5"></i>회원가입</a>
					<a class="btn btn-xs btn-info marginL5" href="findidpw.asp"><i class="fa fa-question marginR5"></i>아이디/비밀번호찾기</a>
		...
		<div class="topmenu-banner-notice">
			<div class="container">
				<div class="title">지금 회원가입만 하셔도,<br> <b>매일 무료문자</b>가 제공됩니다.<a href="joinstep1.asp" class="btn btn-xs btn-dark">무료혜택 신청하기</a></div>
			</div>
		</div>
...
<div id="bodyWrapper"><div class="container">
	<div class="site-position">
		<a href="../../index.asp">Home</a><i class="fa fa-angle-right"></i>
		<span class="dropdown">
			<a class="dropdown-toggle now" data-toggle="dropdown" href="#" id="curr_menu"></a>
			<ul class="dropdown-menu pull-right" role="menu">
				<li id="pos_01"><a href="joinstep1.asp">회원가입</a></li>
				<li id="pos_02"><a href="findidpw.asp">아이디/비밀번호찾기</a></li>
				<li id="pos_03"><a href="login.asp">로그인</a></li>
				<li id="pos_04"><a href="javascript:viewAgreement()">서비스이용약관</a></li>
				<li id="pos_05"><a href="javascript:viewPrivacy()">개인정보취급방침</a></li>
				<li id="pos_06"><a href="javascript:viewNospam()">스팸관리규약</a></li>
			</ul>
		</span>
	</div>
</div>
<div class="container">
	<div class="row">
		...
		<div class="panel panel-sm panel-success">
			<div class="panel-heading">
				<h4><i class="fa fa-user marginR5"></i>회원서비스</h4>
			</div>
			<div class="list-group">
				<a href="joinstep1.asp" class="list-group-item" id="left_01">회원가입</a>
				<a href="findidpw.asp" class="list-group-item" id="left_02">아이디/비밀번호찾기</a>
				<a href="login.asp" class="list-group-item" id="left_03">로그인</a>
				<a href="javascript:viewAgreement()" class="list-group-item" id="left_04">서비스이용약관</a>
				<a href="javascript:viewPrivacy()" class="list-group-item" id="left_05">개인정보취급방침</a>
				<a href="javascript:viewNospam()" class="list-group-item" id="left_06">스팸관리규약</a>
			</div>
			<div class="panel-footer f12px" style="line-height:24px;">
				...
				<i class="fa fa-envelope-o W20 fRed"></i>&nbsp;문자상담 : <a href="sms:15992381">1599-2381</a><br />
			</div>
		</div>
				<!-- LEFT / 발신번호 사전등록제 -->
	...
	<div class="">
		...
		<!-- 우측 본문 -->
		<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 paddingB20">
			<div class="bs-callout bs-callout-danger">
				<h4 class="text-info">아이디/비밀번호 찾기</h4>
				<p><small>가입된 정보나 본인인증으로 확인합니다.</small></p>
			</div>
			<div class="page-nav">
				<ul class="nav nav-pills ">
					<li id="tabIDPW2" class="active"><a href="findidpw.asp%3Fkind=2"><i class="fa fa-lock marginR5 hidden-xs"></i>본인인증으로 찾기</a></li>
					<li id="tabIDPW1" class=""><a href="findidpw.asp%3Fkind=1"><i class="fa fa-info-circle marginR5 hidden-xs"></i>내등록 정보로 찾기</a></li>
				</ul>
			</div>
						<div class="row">
				<!-- 아이디찾기 -->
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 marginT20">
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4><i class="fa fa-search fa-lg marginR5"></i> 아이디 찾기</h4>
						</div>
						<div class="panel-body">
							<p><i class="fa fa-check"></i> 본인인증된 아이디를 찾습니다.</p>
							<form name="frmID" id="frmID" method="post" onsubmit="return false">
							<input type="hidden" name="kind" value="2">
							<input type="hidden" name="chkType" value="FINDID">
							<input type="hidden" name="chkAuth" value="">
							<input type="hidden" name="chkGubun" value="">
							<div class="form-group form-group-sm">
								<label>가입유형</label>
								<div class="dropdown">
									<button type="button" class="btn btn-default form-control btn-sm dropdown-toggle form-control dropdown-toggle-btn100" data-toggle="dropdown" data-default="가입유형" aria-haspopup="true" aria-expanded="false" ><span class='title'>가입유형</span><span class="caret"></span></button><ul class="dropdown-menu W100per" data-container="body"><li><a onclick="changeChkGubun('',$(this));" class="dropdown-item f12px ellipsis">가입유형</a></li><li><a onclick="changeChkGubun('1',$(this));" class="dropdown-item f12px ellipsis">개인회원</a></li><li><a onclick="changeChkGubun('2',$(this));" class="dropdown-item f12px ellipsis">기업회원</a></li></ul>
								</div>
							</div>
							<div class="form-group form-group-sm">
								<label>인증방법</label>
								<div class="dropdown">
									<button type="button" class="btn btn-default form-control btn-sm dropdown-toggle form-control dropdown-toggle-btn100" data-toggle="dropdown" data-default="인증방법" aria-haspopup="true" aria-expanded="false" ><span class='title'>인증방법</span><span class="caret"></span></button><ul class="dropdown-menu W100per" data-container="body"><li><a onclick="changeChkAuthID('',$(this));" class="dropdown-item f12px ellipsis">인증방법</a></li><li><a onclick="changeChkAuthID('I',$(this));" class="dropdown-item f12px ellipsis">아이핀인증</a></li><li><a onclick="changeChkAuthID('M',$(this));" class="dropdown-item f12px ellipsis">휴대폰인증</a></li></ul>
								</div>
							</div>
							</form>
							<p id="textFINDID" class="f12px text-danger">&nbsp;</p>
						</div>
						<div class="panel-footer text-center">
							<button type='button' class="btn btn-primary" onclick="FindID()">아이디찾기</button>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 marginT20">
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4><i class="fa fa-search fa-lg marginR5"></i> 비밀번호 재발급</h4>
						</div>
						<div class="panel-body">
							<p><i class="fa fa-check"></i> 본인인증된 아이디의 비밀번호를 재발급합니다.</p>
							<form name="frmPW" id="frmPW" method="post" onsubmit="return false">
							<input type="hidden" name="kind" value="2">
							<input type="hidden" name="chkType" value="FINDPW">
							<input type="hidden" name="chkAuth" value="">
							<div class="form-group form-group-sm">
								<label>아이디</label>
								<input type="text" name="chkGubun" id="chkGubunPW2" value="" class="form-control" placeholder="아이디를 입력하세요." maxlength="16">
							</div>
							<div class="form-group form-group-sm">
								<label>인증방법</label>
								<div class="dropdown">
									<button type="button" class="btn btn-default form-control btn-sm dropdown-toggle form-control dropdown-toggle-btn100" data-toggle="dropdown" data-default="인증방법" aria-haspopup="true" aria-expanded="false" ><span class='title'>인증방법</span><span class="caret"></span></button><ul class="dropdown-menu W100per" data-container="body"><li><a onclick="changeChkAuthPW('',$(this));" class="dropdown-item f12px ellipsis">인증방법</a></li><li><a onclick="changeChkAuthPW('I',$(this));" class="dropdown-item f12px ellipsis">아이핀인증</a></li><li><a onclick="changeChkAuthPW('M',$(this));" class="dropdown-item f12px ellipsis">휴대폰인증</a></li></ul>
								</div>
							</div>
							</form>
							<p id="textFINDPW" class="f12px text-danger">&nbsp;</p>
						</div>
						<div class="panel-footer text-center">
							<button type='button' class="btn btn-primary" onclick="FindPW()">재발급하기</button>
						</div>
					</div>
				</div>
			</div>
			<div class="alert alert-danger marginT20">
				<ul class="paddingL20 f12px">
					<li><p>본인명의의 휴대폰 또는 아이핀 인증을 통해 찾을 수 있습니다.</p></li>
					<li><p>본인인증되지 않은 기존계정은 <span class="label label-info f11px"><i class="fa fa-info-circle marginR5"></i>내등록 정보로 찾기</span>를 이용해주세요.</p></li>
					<li><p><span class="fBlue">휴대폰인증</span> - 인증받은 해당 휴대폰으로 임시비밀번호가 발급됩니다.</p></li>
					<li><p><span class="fGreen">아이핀인증</span> - 회원가입시 등록된 휴대폰으로 임시비밀번호가 발급됩니다.</p></li>
				</ul>
			</div>
			<div id="divCommonPopTip1" class="popupContent" data-icon="" data-code="0">
				<div class="title">팝업차단 해제하기</div>
				<div class="body"><p class="text-center"><img src='../images/notice/popup_bloker_guide.gif'></p></div>
			</div>
...
<form name="frmAuth" method="post" target="frameHidden">
...
<div class="main-banner-bar type1">
	<div class="container">
		...
		<div class="box">
			...
			<a class="btn btn-danger" href="joinstep1.asp">무료 회원가입</a>
		...
		<div class="modal-dialog type-primary">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="nexturl" value="/xclient/member/findidpw.asp">
					...
					<a class="btn btn-xs btn-danger" href="joinstep1.asp">회원가입</a>
					<a class="btn btn-xs btn-info" href="findidpw.asp">아이디/비번찾기</a>
					</span>
					<!-- login form -->
				</div>
