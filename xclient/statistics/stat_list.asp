		...
		<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 paddingB20">
			...
			<div>
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
					...
					<input type="hidden" name="nexturl" value="https://www.xonda.net/xclient/statistics/stat_list.asp">
		...
		<div class="modal-dialog type-primary">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="nexturl" value="/xclient/member/login.asp?nexturl=https%3A%2F%2Fwww%2Exonda%2Enet%2Fxclient%2Fstatistics%2Fstat%5Flist%2Easp">
					<input type="hidden" name="https" value="ON">
					<div class="form-group">
