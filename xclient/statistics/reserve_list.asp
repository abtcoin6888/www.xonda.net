		...
		<div class="row">
			...
			<div class="collapse navbar-collapse bs-navbar-collapse" role="navigation" id="bs-navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" data-id="menu-stat" data-flag="menu" href="sent_msg.asp" id="topmenu_04">전송관리</a>
						<ul class="dropdown-menu" role="menu">
		...
		<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 paddingB20">
			...
			<div>
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
					...
					<input type="hidden" name="nexturl" value="https://www.xonda.net/xclient/statistics/reserve_list.asp">
		...
		<div class="modal-dialog type-primary">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="nexturl" value="/xclient/member/login.asp?nexturl=https%3A%2F%2Fwww%2Exonda%2Enet%2Fxclient%2Fstatistics%2Freserve%5Flist%2Easp">
					<input type="hidden" name="https" value="ON">
					<div class="form-group">
